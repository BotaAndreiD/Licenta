...
namespace ECGMonitor.Validation
{
    ...
    public static class WfdbReader
    {
        ...
        // "lățime QRS" din detector nu are cum să le prindă, distincția lor clinică vine
        // din morfologia undei P, pe care aplicația n-o folosește ca semnal separat.
        private static readonly HashSet<int> VentricularPrematureCodes = new() { 4, 5, 6 };

        public static bool IsVentricularPrematureCode(int code) =>
            VentricularPrematureCodes.Contains(code);

        // Subset supraventricular: J=NPC(7), A=APC(8), S=SVPB(9) — origine atrială/nodală,
        // QRS tipic îngust; distincția lor clinică vine din morfologia/timing-ul undei P.
        private static readonly HashSet<int> SupraventricularPrematureCodes = new() { 7, 8, 9 };
